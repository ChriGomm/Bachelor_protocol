...
\begin{align*}
    ...
    -2\,\kappa^2\,m_y\,( m_x^2+ m_y^2)+2\,\kappa\omega\,(m_x^2+2\,m_y^2)  &=0
\end{align*}
This I did by solving the first equation for y and plugging the result into the second equation. Then I divided the x-axis into a grid and searched bewtween the gridpoints for roots in order find all of the fixed points.
\begin{figure}[H]
    % \vspace*{-1cm}
    \hspace*{-1.2cm}
