...
\begin{align*}
    ...
    \end{array}\right)=&\left( \begin{array}{ccc}
        ...
        0 & -\Gamma\,A-3\,y^2+4\,\frac{\tilde{\omega}}{\tilde{\kappa}}\,y-\frac{\tilde{\omega}^2}{\tilde{\kappa}^2} & \sqrt{2}\,\frac{\Gamma}{\tilde{\kappa}^2}\,(\tilde{\kappa}\,y-\tilde{\omega})\\
...
\end{figure}
% I address the limit to which $y$ tends by working with the original equation
% \begin{align*}
%     0=-\frac{\omega\Gamma}{2}-\half\,\Gamma\,(\Gamma+\gamma-\kappa)\,y-\kappa^2\,y^3+2\,\omega\kappa\,y^2-\omega^2\,y
% \end{align*}
% First the case $\omega\rightarrow\infty$ is considered. There we have to possibilities to assure the $\chi$ is constant 
% \begin{align*}
%     1.\quad 
% \end{align*}
% \begin{align*}
%     \omega^2\,y=0
% \end{align*}
% dominates, infering $m_y\rightarrow0$, which means $|m|\rightarrow1/2$. In the case $\Gamma\rightarrow0$
% \begin{align*}
...
\end{wrapfigure}
% \begin{figure*}[H]
%     \includegraphics{pictures/blanc.png}
%     \caption{l}
% \end{figure*}
...
the total collective spin reaches it's boundies in this limit as well. The $m_y=0$ column in the plot for the smallest $m_y$-fixed points stems from the fact that for $\omega=0$ $m_y=0$ is a solution to the stationary problem. \newpage
