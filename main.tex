...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \newcommand{\tpauthorname}{Marcel Cech}
% \newcommand{\tpsupervisors}{Prof. Dr. Igor Lesanovsky\\ Dr. Federico Carollo}
% \newcommand{\tpevaluators}{Prof. Dr. Igor Lesanovsky\\ Prof. Dr. Daniel Braun}
% \newcommand{\tptypeofthesis}{Master Thesis}
...
% \newcommand{\tptitle}{Quantum Simulation of Biased Open-System Dynamics}
% \newcommand{\tpdate}{June 7., 2023}
